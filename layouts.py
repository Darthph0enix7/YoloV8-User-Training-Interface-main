...
def detection_page_layout():
    layout = [
        [sg.Radio('Object Detection', "RADIO2", default=True, key='object_detection', tooltip='Perform object detection'), sg.Radio('Segmentation', "RADIO2", key='segmentation', tooltip='Perform image segmentation'), sg.Radio('classification', "RADIO2", key='classification', tooltip='Perform image classification')],
        [sg.InputText(key='video', readonly=True, do_not_clear=True, enable_events=True, size=(40, 1)), sg.FileBrowse('Browse Video/Image', file_types=(('All Files', '*.*'), ('Image Files', '*.jpg *.jpeg *.png'),('Video Files', '*.mp4') ), tooltip='Choose a video or image file')],
        ...
        [sg.Text('Extra options:'),sg.Listbox(['Show labels', 'Show confidence'], key='dropdown_options', size=(20, 2), select_mode=sg.LISTBOX_SELECT_MODE_MULTIPLE, enable_events=True, tooltip='Select extra options for object detection or segmentation')],
